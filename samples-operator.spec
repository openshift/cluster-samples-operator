...
%global package_name ose-cluster-samples-operator # PACKAGE_NAME
%global product_name ose-cluster-samples-operator # PRODUCT_NAME
%global import_path github.com/openshift/cluster-samples-operator # GO_PACKAGE

Name:           %{package_name}
Version:        %{version}
Release:        %{release}%{?dist}
Summary:        OSE Cluster Samples Operator
License:        ASL 2.0
...
for bin in cluster-samples-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-samples-operator
